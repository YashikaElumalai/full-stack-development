/* ==========================================================================
   SkillPath — Consolidated Application Script (app.js)
...
/* ============================== enrollments-data.js ============================== */
/* ==========================================================================
   SkillPath — Shared Enrollments & Progress Data Store
   ...
   ========================================================================== */
(function (window) {
    var STORAGE_KEY = 'skillpath_enrollments';
    var CURRENT_STUDENT_KEY = 'skillpath_current_student';
...
/* ==========================================================================
   SkillPath — Course Content Data Store
...
(function (window) {
    ...
    function fieldLabelSafe(fieldId) {
        if (window.SkillPathData && window.SkillPathData.fieldLabel) return window.SkillPathData.fieldLabel(fieldId);
        return fieldId;
    }
...
/* ============================== Page dispatch ============================== */
window.SkillPath = window.SkillPath || {};
SkillPath.pages = {};
...
SkillPath.currentPage = (function () {
...
if (SkillPath.currentPage === 'edit-course') {
...
/* ---------- admin-dashboard ---------- */
SkillPath.pages['admin-dashboard'] = function () {
(function () {
            var CD = window.SkillPathData;
            var E = window.SkillPathEnrollments;
            ...
            window.addEventListener('storage', function (e) {
                if (e.key === 'skillpath_enrollments' || e.key === 'skillpath_courses') {
                    renderAll();
                }
            });
        })();
...
/* ---------- admin-login ---------- */
SkillPath.pages['admin-login'] = function () {
...
/* ---------- admin-schema-login ---------- */
SkillPath.pages['admin-schema-login'] = function () {
document.getElementById('adminLoginForm').addEventListener('submit', function(event) {
            event.preventDefault();
...
/* ---------- course ---------- */
SkillPath.pages['course'] = function () {
(function () {
            var params = new URLSearchParams(window.location.search);
            var courseId = params.get('course') || params.get('id');

            var Data = window.SkillPathData;
            var Content = window.SkillPathCourseContent;
            var E = window.SkillPathEnrollments;
            ...
            document.title = course.title + ' | SkillPath';
...
/* ---------- courses ---------- */
SkillPath.pages['courses'] = function () {
(function () {
            function escapeHtml(str) {
                var div = document.createElement('div');
                div.textContent = str == null ? '' : String(str);
            ...
            function renderCourses() {
                var courses = window.SkillPathData.loadCourses();
            ...
            function isLoggedIn() {
                var student = window.SkillPathEnrollments && window.SkillPathEnrollments.getCurrentStudent();
            ...
            function setupAuthUI() {
                ...
                if (isLoggedIn()) {
                    ...
                    authBtn.addEventListener('click', function (e) {
                        e.preventDefault();
                        window.SkillPathEnrollments.clearCurrentStudent();
...
SkillPath.pages['edit-course'] = function () {
(function () {
            var data = window.SkillPathData;
            var Content = window.SkillPathCourseContent;
...
/* ---------- notifications ---------- */
SkillPath.pages['notifications'] = function () {
(function () {
            var E = window.SkillPathEnrollments;
            var D = window.SkillPathData;
            ...
            var READ_KEY_GLOBAL = 'skillpath_notif_read_global';

            function readKeyFor(scope) {
                if (scope === 'global') return READ_KEY_GLOBAL;
                return 'skillpath_notif_read_' + scope; // scope = rollNo
            }
...
/* ---------- stu-login-enroll ---------- */
SkillPath.pages['stu-login-enroll'] = function () {
(function () {
            var params = new URLSearchParams(window.location.search);
            ...
            if (courseId && (!courseTitle) && window.SkillPathData) {
                var all = window.SkillPathData.loadCourses();
...
/* ---------- student-dashboard ---------- */
SkillPath.pages['student-dashboard'] = function () {
(function () {
            var E = window.SkillPathEnrollments;
            ...
            function fieldLabel(fieldId) {
                if (window.SkillPathData) return window.SkillPathData.fieldLabel(fieldId);
                return fieldId;
            }
...
/* ---------- student-login ---------- */
SkillPath.pages['student-login'] = function () {
document.querySelector('.auth-form-wrap form').addEventListener('submit', function (event) {
            ...
            if (window.SkillPathEnrollments) {
                var E = window.SkillPathEnrollments;
...
document.addEventListener('DOMContentLoaded', function () {
    var init = SkillPath.pages[SkillPath.currentPage];
